...
enum WorldBoolConfigs
{
    ...
    CONFIG_SOLO_3V3_EQUIP_AND_TALENTS,
    CONFIG_SOLO_3V3_BLOCK_FORBIDDEN_TALENTS,
...
enum WorldFloatConfigs
{
    ...
    CONFIG_FAKE_PLAYER_LEVELUP_MOD,
    CONFIG_FAKE_PLAYER_RETURN_CHANCE,
...
enum WorldIntConfigs
{
    ...
    CONFIG_FAKE_PLAYER_MIN_COUNT,
    CONFIG_FAKE_PLAYER_MAX_COUNT,
    CONFIG_FAKE_PLAYER_MIN_LEVEL_TIME,
    CONFIG_FAKE_PLAYER_MAX_LEVEL_TIME,
    CONFIG_FAKE_PLAYER_UPDATE_COUNT_TIME_MIN,
    CONFIG_FAKE_PLAYER_UPDATE_COUNT_TIME_MAX,
    CONFIG_FAKE_PLAYER_UPDATE_PLAYERS_TIME_MIN,
    CONFIG_FAKE_PLAYER_UPDATE_PLAYERS_TIME_MAX,
    CONFIG_FAKE_PLAYER_UPDATE_ALLOWED_TIME_MIN,
    CONFIG_FAKE_PLAYER_UPDATE_ALLOWED_TIME_MAX,
    CONFIG_FAKE_PLAYER_ALLOWED_RELOGIN_TIME_MIN,
    CONFIG_FAKE_PLAYER_ALLOWED_RELOGIN_TIME_MAX,
    CONFIG_FAKE_PLAYER_ZONE_CHANGE_TIME_MIN,
    CONFIG_FAKE_PLAYER_ZONE_CHANGE_TIME_MAX,
    CONFIG_FAKE_PLAYER_LOGOUT_TIME_MIN,
    CONFIG_FAKE_PLAYER_LOGOUT_TIME_MAX,
    CONFIG_FAKE_PLAYER_PER_UPDATE_MIN,
    CONFIG_FAKE_PLAYER_PER_UPDATE_MAX,
    CONFIG_FAKE_PLAYER_FILL_TIME,
    CONFIG_FAKE_PLAYER_BURST_TIME,
    CONFIG_FAKE_PLAYER_BURST_VALUE,
    CONFIG_PVP_ZONE_TOKEN_ID,
    CONFIG_PVP_ZONE_TOKEN_COUNT,
    ...
    CONFIG_PVP_ARENA_TOKEN_ID,
    CONFIG_PVP_ARENA_TOKEN_COUNT,
