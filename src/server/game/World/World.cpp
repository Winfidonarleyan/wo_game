...
void World::LoadConfigSettings(bool reload)
{
    ...
    m_bool_configs[CROSSFACTION_SYSTEM_BATTLEGROUNDS] = sConfigMgr->GetBoolDefault("CrossFactionSystem.Battlegrounds.Enabled", true);
    ...
    // Custom
    rate_values[RATE_VIP_XP] = sConfigMgr->GetFloatDefault("VIP.Rates.XP", 1.0f);
    rate_values[RATE_VIP_HONOR_POINTS] = sConfigMgr->GetFloatDefault("VIP.Rates.HonorPoints", 1.0f);
    rate_values[RATE_VIP_REPUTATION] = sConfigMgr->GetFloatDefault("VIP.Rates.Reputation", 1.0f);

    m_int_configs[CONFIG_FAKE_PLAYER_MIN_COUNT] = sConfigMgr->GetIntDefault("FakePlayers.MinCount", 0);
    m_int_configs[CONFIG_FAKE_PLAYER_MAX_COUNT] = sConfigMgr->GetIntDefault("FakePlayers.MaxCount", 0);
    m_int_configs[CONFIG_FAKE_PLAYER_MIN_LEVEL_TIME] = sConfigMgr->GetIntDefault("FakePlayers.MinLevelTime", 10);
    m_int_configs[CONFIG_FAKE_PLAYER_MAX_LEVEL_TIME] = sConfigMgr->GetIntDefault("FakePlayers.MaxLevelGainTime", 120);
    m_float_configs[CONFIG_FAKE_PLAYER_LEVELUP_MOD] = sConfigMgr->GetFloatDefault("FakePlayers.LevelUpTimeMod", 1.0f);

    m_int_configs[CONFIG_FAKE_PLAYER_UPDATE_COUNT_TIME_MIN] = sConfigMgr->GetIntDefault("FakePlayers.UpdateCount.Min", 10);
    m_int_configs[CONFIG_FAKE_PLAYER_UPDATE_COUNT_TIME_MAX] = sConfigMgr->GetIntDefault("FakePlayers.UpdateCount.Max", 30);

    m_int_configs[CONFIG_FAKE_PLAYER_UPDATE_PLAYERS_TIME_MIN] = sConfigMgr->GetIntDefault("FakePlayers.UpdatePlayers.Min", 10);
    m_int_configs[CONFIG_FAKE_PLAYER_UPDATE_PLAYERS_TIME_MAX] = sConfigMgr->GetIntDefault("FakePlayers.UpdatePlayers.Max", 30);

    m_int_configs[CONFIG_FAKE_PLAYER_UPDATE_ALLOWED_TIME_MIN] = sConfigMgr->GetIntDefault("FakePlayers.UpdateAllowed.Min", 10);
    m_int_configs[CONFIG_FAKE_PLAYER_UPDATE_ALLOWED_TIME_MAX] = sConfigMgr->GetIntDefault("FakePlayers.UpdateAllowed.Max", 30);

    m_int_configs[CONFIG_FAKE_PLAYER_ALLOWED_RELOGIN_TIME_MIN] = sConfigMgr->GetIntDefault("FakePlayers.AllowedReloginTime.Min", 1);
    m_int_configs[CONFIG_FAKE_PLAYER_ALLOWED_RELOGIN_TIME_MAX] = sConfigMgr->GetIntDefault("FakePlayers.AllowedReloginTime.Max", 240);

    m_int_configs[CONFIG_FAKE_PLAYER_ZONE_CHANGE_TIME_MIN] = sConfigMgr->GetIntDefault("FakePlayers.ZoneChange.Min", 5);
    m_int_configs[CONFIG_FAKE_PLAYER_ZONE_CHANGE_TIME_MAX] = sConfigMgr->GetIntDefault("FakePlayers.ZoneChange.Max", 15);

    m_int_configs[CONFIG_FAKE_PLAYER_LOGOUT_TIME_MIN] = sConfigMgr->GetIntDefault("FakePlayers.LogoutTime.Min", 1);
    m_int_configs[CONFIG_FAKE_PLAYER_LOGOUT_TIME_MAX] = sConfigMgr->GetIntDefault("FakePlayers.LogoutTime.Max", 240);

    m_int_configs[CONFIG_FAKE_PLAYER_PER_UPDATE_MIN] = sConfigMgr->GetIntDefault("FakePlayers.PerUpdate.Min", 3);
    m_int_configs[CONFIG_FAKE_PLAYER_PER_UPDATE_MAX] = sConfigMgr->GetIntDefault("FakePlayers.PerUpdate.Max", 5);

    m_int_configs[CONFIG_FAKE_PLAYER_FILL_TIME] = sConfigMgr->GetIntDefault("FakePlayers.FillTime", 30);
    m_int_configs[CONFIG_FAKE_PLAYER_BURST_TIME] = sConfigMgr->GetIntDefault("FakePlayers.Burst.Time", 3);
    m_int_configs[CONFIG_FAKE_PLAYER_BURST_VALUE] = sConfigMgr->GetIntDefault("FakePlayers.Burst.Value", 5);

    m_int_configs[CONFIG_PVP_ZONE_TOKEN_ID] = sConfigMgr->GetIntDefault("PVPZone.Token.Id", 0);
    m_int_configs[CONFIG_PVP_ZONE_TOKEN_COUNT] = sConfigMgr->GetIntDefault("PVPZone.Token.Count", 1);
    ...
    m_int_configs[CONFIG_SOLO_3V3_COSTS] = sConfigMgr->GetIntDefault("Solo.3v3.Costs", 0);
    m_float_configs[CONFIG_SOLO_3V3_ARENAPOINTS_MULTI] = sConfigMgr->GetFloatDefault("Solo.3v3.Rate.Arenapoints", 0.45f);
    m_bool_configs[CONFIG_SOLO_3V3_FILTER_TALENTS] = sConfigMgr->GetBoolDefault("Solo.3v3.Filter.Talents", false);
    m_bool_configs[CONFIG_SOLO_3V3_VENDOR_RATING] = sConfigMgr->GetBoolDefault("Solo.3v3.Vendor.Rating", false);
    ...
    m_bool_configs[CONFIG_SOLO_3V3_BLOCK_FORBIDDEN_TALENTS] = sConfigMgr->GetBoolDefault("Solo.3v3.Block.ForbiddenTalents", false);
    m_bool_configs[CONFIG_SOLO_3V3_EQUIP_AND_TALENTS] = sConfigMgr->GetBoolDefault("Solo.3v3.Check.Equip.And.Talents", false);
    m_bool_configs[CONFIG_SOLO_3V3_CAST_DESERTER_ON_AFK] = sConfigMgr->GetBoolDefault("Solo.3v3.Cast.Deserter.On.Afk", false);
    m_bool_configs[CONFIG_SOLO_3V3_CAST_DESERTER_ON_LEAVE] = sConfigMgr->GetBoolDefault("Solo.3v3.Cast.Deserter.On.Leave", false);
    m_bool_configs[CONFIG_SOLO_3V3_STOP_GAME_INCOMPLETE] = sConfigMgr->GetBoolDefault("Solo.3v3.Stop.Game.Incomplete", false);
    ...
    // Arena item
    m_int_configs[CONFIG_PVP_ARENA_TOKEN_ID] = sConfigMgr->GetIntDefault("Pvp.Arena.Token.Id", 0);
    m_int_configs[CONFIG_PVP_ARENA_TOKEN_COUNT] = sConfigMgr->GetIntDefault("Pvp.Arena.Token.Count", 1);
...
void World::SetInitialWorldSettings()
{
    ...
    TC_LOG_INFO("server.loading", "Loading visual enchants...");
    sObjectMgr->LoadEnchantVisual();
    ...
    TC_LOG_INFO("server.loading", "Loading forbidden texts...");
    sObjectMgr->LoadForbiddenTexts();
