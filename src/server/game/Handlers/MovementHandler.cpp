...
void WorldSession::HandleMovementOpcodes(WorldPacket& recvData)
{
    ...
    bool rotationopcode = opcode == MSG_MOVE_START_TURN_LEFT || opcode == MSG_MOVE_START_TURN_RIGHT || opcode == MSG_MOVE_STOP_TURN;
    if (!rotationopcode && plrMover && !mover->CheckMovementInfo(movementInfo))
