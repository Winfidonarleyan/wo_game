...
void SpellMgr::LoadSpellInfoCustomAttributes()
{
    ...
    for (uint32 i = 0; i < GetSpellInfoStoreSize(); ++i)
    {
        ...
        switch (spellInfo->SpellFamilyName)
        {
            ...
            case 60182:
            case 60205:
                spellInfo->CastTimeEntry = sSpellCastTimesStore.LookupEntry(24);
                break;
            // Lighting bolt
            // Water bolt
            case 61374:
            case 61375:
                spellInfo->Effects[EFFECT_0].BasePoints = 1200;
                break;
            // Frost Nova
            case 61376:
                spellInfo->Effects[EFFECT_0].BasePoints = 700;
                break;
            // Windshear
            case 52870:
                ...
                break;
            case 57385:
                spellInfo->RangeEntry = sSpellRangeStore.LookupEntry(135);
                break;
            ...
            case 69195: // Purgent blight (4 ranks)
            case 71219:
            case 73031:
            case 73032:
...
void SpellMgr::LoadSpellInfoCorrections()
{
    ...
    ApplySpellFix({ 49575 }, [](SpellInfo* spellInfo)
    {
