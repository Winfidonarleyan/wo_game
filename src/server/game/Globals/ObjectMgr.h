...
typedef std::map<ObjectGuid::LowType, uint32> EnchantItemsContainer;
...
class TC_GAME_API ObjectMgr
{
    ...
    public:
        ...
        uint32 GetEnchantVisual(ObjectGuid::LowType itemGuid);
        void SetEnchantVisual(ObjectGuid::LowType itemGuid, uint32 visualEntry);
        void RemoveEnchantVisual(ObjectGuid::LowType itemGuid);
        ...
        void LoadForbiddenTexts();
        std::vector<std::string> GetForbiddenTexts() { return _forbiddenTexts; }
    ...
    private:
        ...
        EnchantItemsContainer _enchantItemsStore;
        ...
        std::vector<std::string> _forbiddenTexts;
};
