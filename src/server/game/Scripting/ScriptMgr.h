...
class TC_GAME_API PlayerScript : public UnitScript
{
    ...
    public:
        ...
        // Called when a player gains Arena Points (before anything is given)
        virtual void OnGiveArenaPoints(Player* /*player*/, float& /*amount*/, float& bonusPoints) { }

        // Called when a player gains Arena Points (when offline, before anything is given)
        virtual void OnGiveArenaPoints(ObjectGuid /*guid*/, float& /*amount*/, float& bonusPoints) { }
...
class TC_GAME_API ScriptMgr
{
    ...
    public: /* PlayerScript */
        ...
        void OnGivePlayerHonorPoints(Player* player, float& amount, float& bonusPoints, Unit* victim);
        void OnGivePlayerArenaPoints(Player* player, float& amount, float& bonusPoints);
        void OnGivePlayerArenaPoints(ObjectGuid guid, float& amount, float& bonusPoints);
