...
void ScriptMgr::OnGivePlayerArenaPoints(Player* player, float& amount, float& bonusPoints)
{
    FOREACH_SCRIPT(PlayerScript)->OnGiveArenaPoints(player, amount, bonusPoints);
}

void ScriptMgr::OnGivePlayerArenaPoints(ObjectGuid guid, float& amount, float& bonusPoints)
{
    FOREACH_SCRIPT(PlayerScript)->OnGiveArenaPoints(guid, amount, bonusPoints);
}
