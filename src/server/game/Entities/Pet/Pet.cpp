...
bool Guardian::InitStatsForLevel(uint8 petlevel)
{
    ...
    switch (petType)
    {
        case SUMMON_PET:
        {
            ...
            if (GetOwner()->getClass() == CLASS_DEATH_KNIGHT)
            {
                if (Aura* aur = GetOwner()->GetAuraOfRankedSpell(55623))
                    CastSpell(this, 32233, true);   // Avoidance
            }
        ...
        case HUNTER_PET:
        {
            ...
            SetStatFlatModifier(UNIT_MOD_STAT_STAMINA, BASE_VALUE, float(m_owner->GetStat(STAT_STAMINA)) * 0.3f);
