...
class TC_GAME_API Player : public Unit, public GridObject<Player>
{
    ...
    public:
        ...
        bool SendBattleGroundChat(uint32 msgtype, Language lang, std::string message);
        ...
        typedef std::function<uint32()> EventHandler;
        void ScheludeEvent(uint32 eventId, uint32 time, EventHandler handler);
    ...
    private:
        ...
        std::unordered_map<uint32, EventHandler> _eventHandlers;
        EventMap _events;
};
