...
public:
    ...
    std::vector<ChatCommand> GetCommands() const override
    {
        ...
        static std::vector<ChatCommand> reloadCommandTable =
        {
			...
			{ "forbidden_texts",               rbac::RBAC_PERM_COMMAND_RELOAD_ALL,                              true,  &HandleReloadForbiddenTextsCommand,             "" },
    ...
    static bool HandleReloadForbiddenTextsCommand(ChatHandler* handler, const char* /*args*/)
    {
        TC_LOG_INFO("misc", "Reloading forbidden texts...");
        sObjectMgr->LoadForbiddenTexts();
        handler->SendGlobalGMSysMessage("Forbidden texts reloaded.");
        return true;
    }
