...
public:
    ...
    struct npc_welcomeAI : public ScriptedAI
    {
        npc_welcomeAI(Creature* creature) : ScriptedAI(creature) { }
        ...
        bool GossipHello(Player* player) override
        {
            ...
            AddGossipItemFor(player, TRAINER_ICON, "|cff00ff00|TInterface\\icons\\spell_chargenegative:25|t|r Сбросить мои таланты.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
            AddGossipItemFor(player, TRAINER_ICON, "|cff00ff00|TInterface\\icons\\spell_chargenegative:25|t|r Сбросить таланты моего питомца.", GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 3);
            AddGossipItemFor(player, GOSSIP_ICON_CHAT, "|cff00ff00|TInterface\\icons\\spell_chargepositive:25|t|r Прокачать скилы", GOSSIP_SENDER_MAIN, 2222);
    ...
    {
        return new npc_welcomeAI(creature);
    }
};
